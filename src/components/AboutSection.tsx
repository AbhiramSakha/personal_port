      ...
      <div className="section-container">
        ...
        >
          ...
          <p className="section-subtitle max-w-3xl">
            Passionate developer with 2+ years of coding experience, specializing in AI-powered backend development and scalable web applications.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <motion.div
            ...
            className="glass-card rounded-xl p-8 font-mono text-sm"
          >
