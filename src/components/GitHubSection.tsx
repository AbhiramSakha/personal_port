    ...
    <section id="github" className="relative" ref={ref}>
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="mt-6">
            <img
              src={"https://github-readme-stats.vercel.app/api?username=AbhiramSakha&theme=transparent&hide_border=true&include_all_commits=true&count_private=false&title_color=34d399&text_color=94a3b8&&icon_color=34d399&cache_seconds=1"}
              alt="GitHub stats"
              className="w-full rounded-lg"
              loading="lazy"
          />
