    ...
    <section id="github" className="relative" ref={ref}>
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="mt-6">
            <img
              src={"https://github-readme-stats.vercel.app/api?username=AbhiramSakha&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=false&title_color=34d399&text_color=94a3b8&icon_color=34d399"}
              alt="GitHub stats"
              className="w-full rounded-lg"
              loading="lazy"
          />
        ...
        <div className="mt-4">
          <img
            src={`https://streak-stats.demolab.com/?user=AbhiramSakha&theme=tokyonight&hide_border=true&background=0d1117&ring=34d399&fire=34d399&currStreakLabel=34d399&sideNums=34d399&currStreakNum=34d399&dates=9ca3af`}
